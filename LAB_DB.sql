...
inner join product on product_details.pro_id = product.pro_id inner join category on   
...
END AS verdict FROM supplier,rating where rating.supp_id=supplier.supp_id;
END &&  
DELIMITER ;  
